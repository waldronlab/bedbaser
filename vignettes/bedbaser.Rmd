...
api <- BEDbase(path = tempdir())
```

## (Optional) Set the cache

Set the cache path with the environment variable `BEDBASE_CACHE` or pass to the
constructor when creating an instance. If not set, bedbaser will choose the
default cache location.

```{r BEDBASE_CACHE, eval=FALSE}
