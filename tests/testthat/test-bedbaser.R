...
test_that("Check bb_metadata for BEDs, BEDsets, and objects", {
    ...
    obj <- bb_metadata(client, make_obj_id(ex_bed$record_identifier), "object")
    expect_identical(ex_bed$metadata, obj)
})
